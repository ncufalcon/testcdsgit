...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
                            ...
                            if (response != "nodata") {
                                ...
                                for (var i = 0; i < response.length; i++) {
                                    ...
                                    if (response[i].pacStatus == "0") {
                                        str_html += "<td align='center' class='font-normal' nowrap='nowrap'><input type='checkbox' name='pay_box[]' guid='" + response[i].pacGuid + "' /></td>";
                                    } else {
        ...
        //fancybox回傳
        function setReturnValue(v, gv, pno, pname) {
            switch (v) {
                case "Personnel":
