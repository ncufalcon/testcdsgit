...
public class ashx_AllList : IHttpHandler,System.Web.SessionState.IReadOnlySessionState {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            string DateS = (!string.IsNullOrEmpty(context.Request.Form["DateS"])) ? context.Request.Form["DateS"].ToString() : "";
            string DateE = (!string.IsNullOrEmpty(context.Request.Form["DateE"])) ? context.Request.Form["DateE"].ToString() : "";
            string typ = (!string.IsNullOrEmpty(context.Request.Form["typ"])) ? context.Request.Form["typ"].ToString() : "";

            string[] str = { PerNo, PerName, Code, DateE, DateS, Cost.ToString() };
            ...
            pModel.perNo = PerNo;
            pModel.siItemCode = Code;
            pModel.paCost = Cost;
            pModel.paDateS = DateS;
                pModel.paDateE = DateE;
            if (sqlinj == "")
            {
