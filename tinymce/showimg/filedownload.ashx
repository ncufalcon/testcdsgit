...
{    
    ...
    {
        string strEmpno = "" + context.Request.QueryString["empno"];
        string strFileName = "" + context.Request.QueryString["filename"];

        string strpath = string.Format(System.Configuration.ConfigurationManager.AppSettings["UploadFileRootDir"]+"\\{0}\\{1}", strEmpno, strFileName);
        ...
        if (file.Exists)
        {
            ...
            if (context.Request.Browser.Browser == "IE")
            {
                ...
                strDownloadName = context.Request["filename"];
            }
            else
            {
                strDownloadName = System.Web.HttpUtility.UrlEncode(context.Request["filename"]);
            }
